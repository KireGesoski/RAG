...
class Dataset:
    def __init__(self, dataset_name: str, question: str, prediction: str, endpoint: str | None = None):
        """
        ...
        self.rows = [{"question": question, "prediction": prediction}]
    ...
    def _to_dataframe(self) -> pd.DataFrame:
        return pd.DataFrame(self.rows, columns=["question", "prediction"])
